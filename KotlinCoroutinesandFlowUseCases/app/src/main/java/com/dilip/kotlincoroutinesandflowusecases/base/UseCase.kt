package com.dilip.kotlincoroutinesandflowusecases.base

import android.os.Parcelable
import androidx.appcompat.app.AppCompatActivity
import com.dilip.kotlincoroutinesandflowusecases.usecases.coroutines.usecase1.PerformSingleNetworkRequestActivity
import com.dilip.kotlincoroutinesandflowusecases.usecases.coroutines.usecase10.CalculationInBackgroundActivity
import com.dilip.kotlincoroutinesandflowusecases.usecases.coroutines.usecase11.CooperativeCancellationActivity
import com.dilip.kotlincoroutinesandflowusecases.usecases.coroutines.usecase12.CalculationInSeveralCoroutinesActivity
import com.dilip.kotlincoroutinesandflowusecases.usecases.coroutines.usecase13.ExceptionHandlingActivity
import com.dilip.kotlincoroutinesandflowusecases.usecases.coroutines.usecase14.ContinueCoroutineWhenUserLeavesScreenActivity
import com.dilip.kotlincoroutinesandflowusecases.usecases.coroutines.usecase15.WorkManagerActivity
import com.dilip.kotlincoroutinesandflowusecases.usecases.coroutines.usecase16.PerformanceAnalysisActivity
import com.dilip.kotlincoroutinesandflowusecases.usecases.coroutines.usecase17.PerformCalculationOnMainThreadActivity
import com.dilip.kotlincoroutinesandflowusecases.usecases.coroutines.usecase2.Perform2SequentialNetworkRequestsActivity
import com.dilip.kotlincoroutinesandflowusecases.usecases.coroutines.usecase2.callbacks.SequentialNetworkRequestsCallbacksActivity
import com.dilip.kotlincoroutinesandflowusecases.usecases.coroutines.usecase2.rx.SequentialNetworkRequestsRxActivity
import com.dilip.kotlincoroutinesandflowusecases.usecases.coroutines.usecase3.PerformNetworkRequestsConcurrentlyActivity
import com.dilip.kotlincoroutinesandflowusecases.usecases.coroutines.usecase4.VariableAmountOfNetworkRequestsActivity
import com.dilip.kotlincoroutinesandflowusecases.usecases.coroutines.usecase5.NetworkRequestWithTimeoutActivity
import com.dilip.kotlincoroutinesandflowusecases.usecases.coroutines.usecase6.RetryNetworkRequestActivity
import com.dilip.kotlincoroutinesandflowusecases.usecases.coroutines.usecase7.TimeoutAndRetryActivity
import com.dilip.kotlincoroutinesandflowusecases.usecases.coroutines.usecase7.callbacks.TimeoutAndRetryCallbackActivity
import com.dilip.kotlincoroutinesandflowusecases.usecases.coroutines.usecase7.rx.TimeoutAndRetryRxActivity
import com.dilip.kotlincoroutinesandflowusecases.usecases.coroutines.usecase8.RoomAndCoroutinesActivity
import com.dilip.kotlincoroutinesandflowusecases.usecases.coroutines.usecase9.DebuggingCoroutinesActivity
import com.dilip.kotlincoroutinesandflowusecases.usecases.flow.usecase1.FlowUseCase1Activity
import com.dilip.kotlincoroutinesandflowusecases.usecases.flow.usecase2.FlowUseCase2Activity
import com.dilip.kotlincoroutinesandflowusecases.usecases.flow.usecase3.FlowUseCase3Activity
import com.dilip.kotlincoroutinesandflowusecases.usecases.flow.usecase4.FlowUseCase4Activity
